...
// Layout
const GlobalLayout = React.lazy(() => import('src/love/eLayout/aGlobalLayout'));
const UnprotectedLayout = React.lazy(() => import('src/love/eLayout/bUnprotectedLayout'));
const ProtectedLayout = React.lazy(() => import('src/love/eLayout/cProtectedLayout'));
const AuthenticatedLayout = React.lazy(() => import('src/love/eLayout/dAuthenticatedLayout'));
const AuthorisedLayout = React.lazy(() => import('src/love/eLayout/eAuthorisedLayout'));
const TopbarLayout = React.lazy(() => import('src/love/eLayout/fTopbarLayout'));
const SidebarLayout = React.lazy(() => import('src/love/eLayout/gSidebarLayout'));
